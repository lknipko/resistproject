      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <section className="py-12">
          ...
          <div className="grid gap-4 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
            {THEMES.map((theme) => (
              <Link
                key={theme.tag}
                href={`/environment/topics?tag=${encodeURIComponent(theme.tag)}`}
        ...
        <div className="pb-12 text-center">
          <p className="text-sm text-gray-500">
            ...
            <Link href="/environment/topics" className="text-forest-600 hover:underline font-medium">
              browse all
            </Link>
            {' '}or{' '}
            <Link href="/environment/topics#propose" className="text-forest-600 hover:underline font-medium">
              propose a new topic
            </Link>
          </p>
        </div>
