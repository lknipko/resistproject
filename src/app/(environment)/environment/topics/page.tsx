    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm text-forest-600 mb-3">
          <Link href="/environment" className="hover:underline">Our Home</Link>
      ...
      {sortedPages.length === 0 && activeTag && (
        <div className="text-center py-16">
          <p className="text-gray-500">
            ...
            <Link href="/environment/topics" className="text-forest-600 hover:underline">
              Show all topics
            </Link>
          </p>
        </div>
