      ...
      <form action={emailSignIn} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            autoComplete="email"
            required
            className="relative block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-steel-600 focus:outline-none focus:ring-steel-500 sm:text-sm"
