          ...
          <div className="mt-3 p-2 md:p-4 bg-white border border-gray-200 rounded-md text-sm">
            ...
            <div className="flex justify-between items-center mb-3 gap-3">
              ...
              >
                ...
                {copiedLoggedOut ? 'Copied!' : 'Copy message'}
              </button>
            </div>
...
function RepresentativeEmailCard({
  ...
  // State for "copied to clipboard" feedback on send
        ...
        <div className="flex-shrink-0 text-center">
          {hasEmail ? (
            <a
              ...
              className="inline-block px-6 py-2 bg-orange-600 text-white font-semibold rounded-md hover:bg-orange-700 transition-colors whitespace-nowrap"
            >
              Send Email →
            </a>
          ) : (
            representative.urls[0] && (
              <a
                ...
                rel="noopener noreferrer"
                onClick={handleEmailClick}
                className="inline-block px-3 py-2 bg-orange-600 text-white font-semibold rounded-md hover:bg-orange-700 transition-colors text-center w-20 sm:w-auto"
              >
                Open Contact Form →
              </a>
            )
          ...
          {sendCopied && (
            <p className="text-xs text-green-700 mt-1 font-medium">
              {hasEmail ? 'Message copied to clipboard!' : 'Message copied — paste into the contact form!'}
            </p>
          )}
        </div>
      </div>
